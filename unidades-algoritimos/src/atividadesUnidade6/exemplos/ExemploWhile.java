package atividadesUnidade6.exemplos;
...
public class ExemploWhile {
    ...
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in); // Cria Um Scanner Para Ler Dados Digitados No Teclado

        System.out.print("Informe A Quantidade De Amostras (Maior Que Zero): "); // Solicita Um Numero Ao Usuario
        int amostras = sc.nextInt(); // Le Um Inteiro Digitado
        ...
        while (amostras <= 0) { // Enquanto O Numero For Invalido (Zero Ou Negativo), Continua Repetindo
            ...
            amostras = sc.nextInt(); // Le Novamente Para Alterar A Variavel E Permitir Que A Condicao Mude
        }
